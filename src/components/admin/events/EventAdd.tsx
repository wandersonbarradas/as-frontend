...
export const EventAdd = ({ refreshAction }: Props) => {
    ...
    const eventSchema = z.object({
        titleField: z.string().min(2, "Preencha o titulo."),
        descriptionField: z.string().min(2, "Preencha a descrição"),
    ...
    const handleAddButton = async () => {
        ...
        setLoading(false);
        if (eventItem) return refreshAction();
    };
